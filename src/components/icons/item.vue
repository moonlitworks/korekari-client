<template>
  <g>
    <path
      d="M25.691,25.144v2.685c4.132,0.627,7.207,2.981,7.207,5.796c0,3.297-4.209,5.967-9.399,5.967
			c-5.189,0-9.398-2.671-9.398-5.967c0-2.812,3.075-5.169,7.206-5.796v-2.685H0v18.241h47V25.144H25.691z"
    />
    <path
      d="M21.307,21.854v-4.941h-3.452v-3.03h2.021v-1.254h-4.04V9.6h5.472c0-1.212,0.981-2.189,2.192-2.189
    ...
    />
    <path
      d="M18.829,32.548l-0.001,0.639l0.001,0.051c0.139,2.091,1.273,3.175,2.27,3.296c1.229,0.144,1.874-0.369,2.401-1.05
